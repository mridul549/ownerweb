...
export default function Profile() {
    ...
    const resetPassword = () => {
        ...
        toast.promise(
            fetch(`https://theflavr.in/owner/resetpassword`, {
                method: "PATCH",
                headers: {
    ...
    const handleProfileFormWithoutCheck = async () => {
        toast.promise(
            fetch("https://theflavr.in/owner/updateowner/", {
                method: "PATCH",
                headers: {
                    "Content-Type": "application/json",
                    "Authorization": "Bearer " + localStorage.getItem("token")
    ...
    const handleProfileFormWithCheck = async () => {
        if(ownerForm.email!==beforeEditOwner.email) {
            toast.promise(
                fetch(`https://theflavr.in/owner/ownerprofile?ownermail=${ownerForm.email}`, {
                    method: "GET",
                }).then((response) => response.json()),
                {
                    pending: {
    ...
    const handleImageUpload = async () => {
        ...
        toast.promise(
            fetch("https://theflavr.in/owner/updateImage/", {
                method: "PATCH",
                headers: {
                    "Authorization": "Bearer " + localStorage.getItem("token")
                },
