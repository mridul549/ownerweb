...
export default function OrderItem(props) {
    ...
    const handleRejectionFormSubmit = async (e) => {
        ...
        const response = await fetch("https://theflavr.in/orders/orderconfrej", {
            method: "PATCH",
            headers: {
    ...
    const readyHandler = async (role) => {
        ...
        const response = await fetch("https://theflavr.in/orders/orderReady", {
            method: "PATCH",
            headers: {
                "Content-Type": "application/json",
                "Authorization": "Bearer " + localStorage.getItem('token')
    ...
    const deliverHandler = async (role) => {
        ...
        const response = await fetch("https://theflavr.in/orders/deliverOrder", {
            method: "PATCH",
            headers: {
                "Content-Type": "application/json",
                "Authorization": "Bearer " + localStorage.getItem('token')
