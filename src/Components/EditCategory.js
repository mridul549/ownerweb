...
export default function EditCategory(props) {
    ...
    const deleteProduct = async () => {
        ...
        const response = await fetch("https://theflavr.in/products/deleteProduct", {
            method: "DELETE",
            headers: {
    ...
    const fetchProducts = async () => {
        const response = await fetch(`https://theflavr.in/products/getProductsByCategory?categoryName=${categoryDetails.name}&outletid=${localStorage.getItem('selectedOutlet')}`, {
            method: "GET",
            headers: {
                "Content-Type": "application/json"
            },
    ...
    const handleProductForm = async (event) => {
        ...
        if(isProductModalOpen.action==='add'){
            ...
            const response = await fetch("https://theflavr.in/products/addProduct", {
                method: "POST", 
                headers: {
                    "Authorization": "Bearer " + localStorage.getItem('token')
                },
            ...
            const response = await fetch(`https://theflavr.in/products/updateProduct/${isProductModalOpen.productid}`, {
                method: "PATCH", 
                headers: {
                    "Authorization": "Bearer " + localStorage.getItem('token')
                },
    ...
    const handleUpdateCategory = async () => {
        setLoading(true)
        const response = await fetch(`https://theflavr.in/category/updateCategory?categoryid=${categoryDetails.id}&outletid=${localStorage.getItem('selectedOutlet')}`, {
            method: "PATCH", 
            headers: {
                "Content-Type": "application/json"
            },
    ...
    const handleCategoryForm = async (event) => {
        ...
        setLoading(true)
        const response = await fetch("https://theflavr.in/category/addCategory", {
            method: "POST", 
            headers: {
                "Content-Type": "application/json"
            },
    ...
    useEffect(() => {
        ...
        if(location.pathname===`/dashboard/editcategory/${id}`){
            ...
            const fillForm = async () => {
                ...
                const response = await fetch(`https://theflavr.in/category/getCategory?categoryid=${id}`, {
                    method: "GET"
                })
                const json = await response.json()
        ...
        async function fetchData () {
            const response = await fetch("https://theflavr.in/categoryicon/allicons", {
                method: "GET",
                headers: {
                    "Content-Type": "application/json"
                },
