...
export default function Menu() {
    ...
    const handleCategoryClick =  async (category) => {
        ...
        const response1 = await fetch(`https://theflavr.in/products/getProductsByCategory?categoryName=${category}&outletid=${localStorage.getItem('selectedOutlet')}`, {
            method: "GET",
            headers: {
    ...
    useEffect(() => {
        async function fetchData () {
            ...
            setLoadingCat(true);
            setLoadingPro(true);
            const response = await fetch(`https://theflavr.in/products/getAllCategories?outletid=${localStorage.getItem('selectedOutlet')}`, {
                method: "GET",
                headers: {
                    "Content-Type": "application/json"
                },
            ...
            const response1 = await fetch(`https://theflavr.in/products/getProductsByCategory?categoryName=All&outletid=${localStorage.getItem('selectedOutlet')}`, {
                method: "GET",
                headers: {
                    "Content-Type": "application/json"
                },
