...
export default function Analytics() {
    ...
    useEffect(() => {
        ...
        const fetchData = async () => {
            ...
            switch (chart3.getBy) {
                case 0:
                    const response = await fetch(`http://localhost:3001/outlet/chart/products/day?outletid=${localStorage.getItem('selectedOutlet')}&month=${chart3.month}&year=${chart3.year}&date=${chart3.date+2}`, {
                        method: "GET",
                    })
                    ...
                    break;
                case 1:
                    const response1 = await fetch(`http://localhost:3001/outlet/chart/products/month?outletid=${localStorage.getItem('selectedOutlet')}&year=${chart3.year}&month=${chart3.month}`, {
                        method: "GET",
                    })
                ...
                case 2:
                    const response2 = await fetch(`http://localhost:3001/outlet/chart/products/year?outletid=${localStorage.getItem('selectedOutlet')}&year=${chart3.year}`, {
                        method: "GET",
                    })
