...
export default function Analytics() {
    ...
    useEffect(() => {
        ...
        const fetchData = async () => {
            ...
            switch (chart1.getBy) {
                case 0:
                    const response = await fetch(`https://theflavr.in/outlet/chart/revenue/day?outletid=${localStorage.getItem('selectedOutlet')}&month=${chart1.month}&year=${chart1.year}`, {
                        method: "GET",
                    })
                    ...
                    break;
                case 1:
                    const response1 = await fetch(`https://theflavr.in/outlet/chart/revenue/month?outletid=${localStorage.getItem('selectedOutlet')}&year=${chart1.year}`, {
                        method: "GET",
                    })
                ...
                case 2:
                    const response2 = await fetch(`https://theflavr.in/outlet/chart/revenue/year?outletid=${localStorage.getItem('selectedOutlet')}`, {
                        method: "GET",
                    })
