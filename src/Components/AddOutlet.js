...
export default function AddOutlet() {
  ...
  return (
    <>
      <div className="d-flex justify-content-between header-sec">
      <p></p>
      ...
      <div className="outer-div">
        ...
        <button className="btn add-new"  data-bs-dismiss="modal" aria-label="Close">Add New Outlet</button></Link>
        <div className="inner-div">
        {outletArray.map((outlet) => {
                            return <div key={outlet._id}>
                                <OutletInfo image={outlet.outletImage.url} head={outlet.outletName} address={outlet.address} />
                                </div>
                        })}
        </div>
      </div>
